        ...
        const messageListener = (msg) => {
            ...
            switch (msg.status) {
                ...
                case "result-anounced":
                    ...
                    break;
                case "restart":
                    console.log("game-restart"); // show {t("Play Game")} screen ss in phone
                                        ...
                                        <div style={{ display: "flex", justifyContent: "center", alignContent: "center" }}>
                                            {game?.user_selected_ball > 0 ?
                                                <>
                                                    ...
                                                    &nbsp;  <img src={game?.user_selected_ball_image_url} alt="..." style={{ width: "5vh", height: "5vh" }} />
                                                </>
                                                :
                                                <></>
                                            }
